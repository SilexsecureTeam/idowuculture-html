            ...
            <div class="flex-1 px-1">
                ...
                <form wire:submit.prevent="placeOrder" class="grid grid-cols-2 gap-2">
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea wire:model="address" id="address" class="w-full border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-yellow-900 transition" placeholder="Address"></textarea>
