    ...
    <div class="min-h-fit py-6 bg-gray-100 my-15 px-5 sm:px-10 lg:px-20">
      ...
      <div class="w-full space-x-4 flex flex-col md:flex-row overflow-hidden">
        ...
        <div class="flex-1 px-1">
          ...
          <!-- Form -->
          <form class="grid grid-cols-2 gap-2" id="checkoutForm" onsubmit="return false;">
            <!-- First Name -->
            <div class="flex flex-col">
              ...
              <input
                ...
                class="border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-yellow-900 transition"
                required
              />
            </div>
            ...
            <!-- Company Name -->
            <div class="flex flex-col">
              <label for="company" class="mb-1 text-sm font-medium text-gray-700">Company Name</label>
              <input
                id="company"
                name="company"
                type="text"
            ...
            <!-- Country -->
            <div class="flex flex-col">
              <label for="country" class="mb-1 text-sm font-medium text-gray-700">Country</label>
              <select
                id="country"
                name="country"
                class="border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-yellow-900 transition"
            ...
            <!-- State -->
            <div class="flex flex-col">
              <label for="state" class="mb-1 text-sm font-medium text-gray-700">State</label>
              <select
                id="state"
                name="state"
                class="border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-yellow-900 transition"
            ...
            <!-- City -->
            <div class="flex flex-col">
              <label for="city" class="mb-1 text-sm font-medium text-gray-700">City</label>
              <input
                id="city"
                name="city"
                type="text"
            ...
            <!-- Postal Code -->
            <div class="flex flex-col">
              <label for="postalCode" class="mb-1 text-sm font-medium text-gray-700">Postal Code</label>
              <input
                id="postalCode"
                name="postalCode"
                type="text"
            ...
            <div class="w-full mt-4 col-span-2">
              <button
                type="submit"
                class="w-full cursor-pointer bg-yellow-900 px-6 text-white py-3 mb-5 font-semibold hover:bg-yellow-800 transition"
              >
                Continue
              </button>
            </div>
        ...
        <div class="w-full md:max-w-96 flex flex-col justify-between mt-10 md:mt-0">
          <div>
            ...
            <div class="flex justify-between border-b border-gray-400 items-center py-3 text-black">
              <span class="font-medium">Flat Rate Shipping</span>
              <span>$11.00</span>
            </div>
...
<!-- footer section -->
  ...
  <footer class="bg-black text-white px-5 sm:px-10 lg:px-20 py-10">
    ...
    <script>
      // Example form submission handling (optional)
