            ...
            <div
                ...
                <div class="w-full max-w-md">
                    ...
                    <form id="loginForm" class="space-y-4">
                        <input type="text" name="identifier" id="identifier" placeholder="Enter your email"
                        ...
                        <label class="flex items-center justify-between w-full mt-2 space-x-2 text-sm">
                            <div class="flex items-center gap-x-3">
                                <input type="checkbox" name="agree" id="agree" class="cursor-pointer" />
                                <span class="text-[#0B0A0A] text-base font-normal">
                                    Remember me
                                </span>
                            </div>
                            <a href="/forgot-password" class="text-[#009345] hover:underline">
                                Forgot password?
                            </a>
                        </label>
